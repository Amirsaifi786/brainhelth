<?php include('header.php'); ?>
    ...
    <section class="about_page services_page">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="breadcome_heading">
                    <h2 class="top_heading">Services</h2>
...
<section class="about-us gap-all">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="take-about">
          <h2 class="sec_heading">Our Services</h2>
           <p class="sec_paragraph">At the core of our commitment is a suite of comprehensive services designed to meet your diverse needs. From expert healthcare solutions to personalized support, we strive to exceed expectations. Our dedicated team ensures a seamless experience, delivering excellence in every aspect. Whether it's precise medical care, tailored assistance, or emotional support, our services are a testament to our unwavering dedication to your well-being. Choose us for a holistic approach that prioritizes your health, comfort, and peace of mind.
          </p>
        </div>
      ...
      <section class="our_services gap-all bggg">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="service sub_heading2">
                <h2 class="sec_heading">Our Services</h2>
                <p class="sec_paragraph">Comprehensive healthcare tailored to individual needs.</p>
              </div>
            </div>          
          </div>
